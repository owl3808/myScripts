...
$IPTABLES -A INPUT -p tcp -d 0/0 --dport 5938 -j DROP
$IPTABLES -A INPUT -p tcp -s 0/0 --sport 5938 -j DROP
$IPTABLES -A INPUT -p tcp -s 0/0 --sport 5938 -j ACCEPT
$IPTABLES -A INPUT -p tcp -d 0/0 --dport 5938 -j ACCEPT
...
# Spotify
$IPTABLES -A INPUT -d 127.0.0.1 -p tcp -m multiport --dports 4371,4381 -j ACCEPT
